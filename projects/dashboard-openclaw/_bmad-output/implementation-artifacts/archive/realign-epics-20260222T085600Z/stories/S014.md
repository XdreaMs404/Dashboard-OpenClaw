# S014 - Indexeur tableaux markdown et schéma (FR-024/FR-025)
...
- Toute modification fonctionnelle des stories S001..S013 non strictement nécessaire à l’intégration S014.
...
8. Export S014 ajouté dans `app/src/index.js` (`indexArtifactMarkdownTables`).
...
- AC-10 coverage: `npm run test:coverage` (S014 `artifact-table-indexer.js` = **99.09% lines**, **96.99% branches**)
...
- `npm run test:coverage` ✅
  ...
  - module S014 `app/src/artifact-table-indexer.js`: **99.13% statements / 96.99% branches / 100% functions / 99.09% lines**
- `npm run build` ✅
