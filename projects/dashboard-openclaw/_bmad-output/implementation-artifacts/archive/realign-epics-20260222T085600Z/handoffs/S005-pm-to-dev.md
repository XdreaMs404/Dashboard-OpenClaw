...
1. `S005.md` définit AC-01..AC-07, contraintes de sécurité, tests unit/edge/e2e, coverage >=95%.
2. `STORIES_INDEX.md` confirme `S005` en statut `TODO` (prêt pour prise en charge DEV H13).
...
6. Tests S005 unit + edge + e2e, coverage module >=95% lignes+branches.

## Scope interdit (hors-scope)
- Toute évolution hors FR-006 / S005.
- Toute modification S001/S002/S003/S004 non strictement nécessaire à l’intégration S005.
- Refactors transverses non requis par AC S005.
...
## Fichiers cibles autorisés (strict S005)
