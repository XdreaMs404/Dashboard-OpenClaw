...
- `app/src/phase-dependency-matrix.js` (module S009, API `buildPhaseDependencyMatrix`)
...
- `coverage` ✅
  ...
  - module S009 `phase-dependency-matrix.js`: **99.64% statements / 99.23% branches / 100% functions / 99.63% lines**
- `build` ✅
