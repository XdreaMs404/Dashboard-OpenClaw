...
1. `S006.md` définit AC-01..AC-07, contraintes de sécurité, tests unit/edge/e2e, coverage >=95%.
...
6. Tests S006 unit + edge + e2e, coverage module >=95% lignes+branches.

## Scope interdit (hors-scope)
- Toute évolution hors FR-006 / S006.
- Toute modification S001/S002/S003/S004 non strictement nécessaire à l’intégration S006.
- Refactors transverses non requis par AC S006.
