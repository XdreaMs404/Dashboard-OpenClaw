...
- Aucun changement métier hors S010 sur S001..S008 (hors export S010 dans `index.js`).
...
5. `npm run test:coverage` ✅
   ...
   - module S010 `app/src/phase-dependency-matrix.js`: **99.64% statements / 99.23% branches / 100% functions / 99.63% lines**
6. `npm run build` ✅
...
- AC-10 (coverage >=95% lignes+branches): PASS (**99.63% lines / 99.23% branches** sur S010)
