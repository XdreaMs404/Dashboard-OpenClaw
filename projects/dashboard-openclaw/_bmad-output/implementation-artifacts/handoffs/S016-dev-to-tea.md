...
- Coverage ✅
  ...
  - S016 module `artifact-table-indexer.js`: **99.13% statements / 96.99% branches / 100% functions / 99.09% lines**
- Build ✅
...
2. Vérifier non-régression S011/S012/S013 et export public index S016.
3. Vérifier seuil S016 coverage module (>=95% lignes/branches) et perf 500 docs (`p95IndexMs <= 2000`, lot `< 60000 ms`).
