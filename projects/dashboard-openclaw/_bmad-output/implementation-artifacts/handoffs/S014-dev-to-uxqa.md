...
- `app/src/artifact-table-indexer.js` (module S014, API `indexArtifactMarkdownTables`)
...
- `coverage` ✅
  ...
  - module S014 `artifact-table-indexer.js`: **99.13% statements / 96.99% branches / 100% functions / 99.09% lines**
- `build` ✅
