...
3. `npx playwright test tests/e2e` ✅
   - 5/5 e2e passés
   - Inclut le test S004 responsive:
...
2. Confirmer non-régression S001/S002/S004.
3. Vérifier prise en compte du correctif responsive S004 (absence overflow) dans le verdict global.
