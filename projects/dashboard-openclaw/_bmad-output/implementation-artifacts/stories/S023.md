...
9. Correctif reviewer appliqué (H18→DEV): fin de la perte silencieuse d’issues parse sans `artifactPath`; comportement désormais fail-closed explicite `INVALID_RISK_ANNOTATION_INPUT` + tests dédiés (AC-01/AC-04).
