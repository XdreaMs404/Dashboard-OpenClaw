# S006 - Exécution contrôlée des guards de phase (sequence-guard + ultra-quality-check)
...
- [x] AC-07 (Seuil qualité): couverture du module S006 >= 95% (lignes + branches).
...
### Sécurité / robustesse
- [x] Allowlist stricte des commandes exécutable par S006 (exactement CMD-008/CMD-009).
...
## Contraintes
- Scope strict S006: pas de modification produit hors FR-006.
...
8. Démonstrateur e2e S006 avec états `empty/loading/error/success`, rendu explicite `reasonCode/reason/commands/failedCommand/failedResult` + vérification responsive (mobile/tablette/desktop sans overflow).
