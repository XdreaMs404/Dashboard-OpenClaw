...
const projectRoot = process.env.BMAD_PROJECT_ROOT || '/root/.openclaw/workspace/bmad-total';
const configPath = process.argv[3] || `${projectRoot}/config/hyper-orchestration.config.json`;
