# SECURITY_DEPENDENCY_WORKER — Source Pack (bmad-worker-security-dependency)

Ce fichier contient les sources BMAD/locales à relire avant exécution du worker.

## Source 1: /root/.openclaw/BMAD/_bmad/bmm/workflows/testarch/ci/checklist.md
...
## Source 2: /root/.openclaw/workspace/bmad-total/scripts/security-scan.sh
