# ACCESSIBILITY_AUDIT_WORKER — Source Pack (bmad-worker-accessibility-audit)

Ce fichier contient les sources BMAD/locales à relire avant exécution du worker.

## Source 1: /root/.openclaw/BMAD/_bmad/bmm/agents/ux-designer.md
...
## Source 2: /root/.openclaw/workspace/bmad-total/templates/UX_AUDIT_TEMPLATE.json

{
  "storyId": "S000",
  "epicId": "E00",
  "verdict": "CONCERNS",
  "reviewer": "ux-qa-auditor",
  "wcagTarget": "2.2-AA",
  "scores": {
    "D1": 0,
    "D2": 0,
  ...
  "checks": {
    ...
    "responsiveCoverage": false,
    "interactionStates": false,
    "visualHierarchy": false,
    "perceivedPerformance": false
  },
  "stateCoverage": {
    "loading": false,
    "empty": false,
  ...
  "evidence": [
    "app/path/to/screenshot-or-report-1",
    "app/path/to/screenshot-or-report-2",
    "app/path/to/screenshot-or-report-3"
  ],
  "issues": [
    "Describe UX/UI issues here"
  ],
  "requiredFixes": [
    "Describe mandatory corrections here"
  ],
  "notes": "",
  "updatedAt": ""
}
